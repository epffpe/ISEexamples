...
#ifndef H_unisim_ver_auxlibM_l_u_t4_H
#define H_unisim_ver_auxlibM_l_u_t4_H
...
class unisim_ver_auxlibM_l_u_t4 : public HSim__s5{
public: 
    unisim_ver_auxlibM_l_u_t4(const char *instname);
    ~unisim_ver_auxlibM_l_u_t4();
    void setDefparam();
    ...
    public: 
        HSim__s3 uv[3];
        cu0(unisim_ver_auxlibM_l_u_t4* arch );
        ...
        unisim_ver_auxlibM_l_u_t4* Arch ;
