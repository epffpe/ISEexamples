#include "isim/work/counter_tbw/testbench_arch.h"
...
#include "work/counter/counter.h"
static HSim__s6* IF30(HSim__s6 *Arch,const char* label,int nGenerics, 
va_list vap)
{
    HSim__s6 *blk = new workMcounter(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("sffsrce", (HSimInstFactoryPtr)IF2);
        (*cfgvh).addVlogModule("X_BUF", (HSimInstFactoryPtr)IF3);
        (*cfgvh).addVlogModule("X_BUFGMUX", (HSimInstFactoryPtr)IF4);
        (*cfgvh).addVlogModule("X_FF", (HSimInstFactoryPtr)IF5);
        (*cfgvh).addVlogModule("X_FF", (HSimInstFactoryPtr)IF6);
        (*cfgvh).addVlogModule("X_INV", (HSimInstFactoryPtr)IF7);
        (*cfgvh).addVlogModule("X_IPAD", (HSimInstFactoryPtr)IF8);
        (*cfgvh).addVlogModule("X_LUT4", (HSimInstFactoryPtr)IF9);
        (*cfgvh).addVlogModule("X_MUX2", (HSimInstFactoryPtr)IF10);
        (*cfgvh).addVlogModule("X_MUX2", (HSimInstFactoryPtr)IF11);
        (*cfgvh).addVlogModule("X_OBUF", (HSimInstFactoryPtr)IF12);
        (*cfgvh).addVlogModule("X_ONE", (HSimInstFactoryPtr)IF13);
        (*cfgvh).addVlogModule("X_OPAD", (HSimInstFactoryPtr)IF14);
        (*cfgvh).addVlogModule("X_SFF", (HSimInstFactoryPtr)IF15);
        (*cfgvh).addVlogModule("X_SFF", (HSimInstFactoryPtr)IF16);
        (*cfgvh).addVlogModule("X_ZERO", (HSimInstFactoryPtr)IF17);
        (*cfgvh).addVlogModule("X_ZERO", (HSimInstFactoryPtr)IF18);
        (*cfgvh).addVlogModule("X_SFF", (HSimInstFactoryPtr)IF19);
        (*cfgvh).addVlogModule("X_OPAD", (HSimInstFactoryPtr)IF20);
        (*cfgvh).addVlogModule("X_ONE", (HSimInstFactoryPtr)IF21);
        (*cfgvh).addVlogModule("X_OBUF", (HSimInstFactoryPtr)IF22);
        (*cfgvh).addVlogModule("X_MUX2", (HSimInstFactoryPtr)IF23);
        (*cfgvh).addVlogModule("X_LUT4", (HSimInstFactoryPtr)IF24);
        (*cfgvh).addVlogModule("X_IPAD", (HSimInstFactoryPtr)IF25);
        (*cfgvh).addVlogModule("X_INV", (HSimInstFactoryPtr)IF26);
        (*cfgvh).addVlogModule("X_FF", (HSimInstFactoryPtr)IF27);
        (*cfgvh).addVlogModule("X_BUFGMUX", (HSimInstFactoryPtr)IF28);
        (*cfgvh).addVlogModule("X_BUF", (HSimInstFactoryPtr)IF29);
        (*cfgvh).addVlogModule("counter", (HSimInstFactoryPtr)IF30);
        (*cfgvh).addVlogModule("glbl", (HSimInstFactoryPtr)IF31);
        HSim__s6 * topvh = 0;
        topvh = new Work_counter_tbw_testbench_arch("counter_tbw");
        addChild(topvh);
        HSim__s5 * topvl = 0;
